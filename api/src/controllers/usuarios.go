...
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("nao pode atualizar um usuario que nao seja voce"))
		return
	}
...
func DeletarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("nao pode deletar um usuario que nao seja voce"))
		return
	}
...
// SeguirUsuario faz a logica de um usuario seguir outro
...
// PararDeSeguirUsuario permite dar unfollow
...
// BuscarSeguidores pega todos os seguidores de um usuario
...
// AtualizarSenha troca a senha do usuário, desde que ele esteja logado na sua conta
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioIDNoToken != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("não é possível atualizar a senha de um usuário que não seja você"))
		return
	}
