...
// BuscarPublicacoes procura por publicações no banco de dados
...
// BuscarPublicacao procura por uma publicação através do seu ID
...
// AtualizarPublicacao altera alguma publicação, tendo como referencia o seu ID
...
// DeletarPublicacao deleta alguma publicação, desde que você seja o criador dela
...
// BuscarPublicacoesPorUsuario procura por publicações de um determinado usuário
